# 05 How to Lead a Team
![team](https://images.unsplash.com/photo-1582213782179-e0d53f98f2ca?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80)

## Why
![leader](https://images.unsplash.com/photo-1541844053589-346841d0b34c?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80)
* **growth** and **productivity** of an engineering team
* 누구나 leader 의 역할을 해야 할 경우가 생긴다.
* leader 의 입장을 이해하고 눈치있는 부하직원이 될 수 있다.
...
### The Tech Lead
* responsible for the technical aspects of the product
...
![authority](https://images.unsplash.com/photo-1515191107209-c28698631303?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=764&q=80)
...
* Engineering 은 정량적인 성과를 얻을 수 있지만 manager는 그렇지 않다
  * manager 의 timeline 도 훨씬 더 길다 (지루하다)
* Peter principle
  ![peter principle](https://upload.wikimedia.org/wikipedia/commons/d/db/Peters_principle.svg)
...
### Servant Leadership
![servant](https://cdn.pixabay.com/photo/2015/03/16/06/56/butler-675453_1280.jpg)
  * 부하에게 목표를 공유하고 부하들의 성장을 도모하면서, 리더와 부하간의 신뢰를 형성시켜 궁극적으로 조직성과를 달성하게 하는 리더십
